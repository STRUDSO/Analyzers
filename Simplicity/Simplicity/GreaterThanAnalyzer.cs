...
namespace Simplicity
{
    ...
    public sealed class GreaterThanAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString Description = "Detects all usages of the greater than sign ('>') in C# code.";
        ...
        private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            ...
            var diagnostic = Diagnostic.Create(Rule, operatorToken.GetLocation());
