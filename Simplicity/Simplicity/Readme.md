...
### Simplicity.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Simplicity.Sample.csproj](../Simplicity.Sample/Simplicity.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
